...
def update_applications():
    ...
    diet_choices = flask.request.form.getlist("dietaryRestrictionsChoices", None)
    ...
    success, error_msg = helpers.handle_update_applications(email, phone_number,
            school, major, degree_type, graduation_year, github, linkedin, resume,
            latino, race, gender, shirt_size, need_transportation, bus_from, airport,
            dietary_restrictions, diet_choices, diet_details, q1, q2, q3, q4, code_of_conduct)
    if success:
