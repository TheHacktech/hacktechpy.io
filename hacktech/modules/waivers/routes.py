...
def medical_information():
    return general_waiver(
        "medical_info",
        link=
        "https://drive.google.com/file/d/1sWA9L2nLlLCI36IFR6D-eN2v-oWQtebA/view?usp=sharing",
        title="MEDICAL INFORMATION DISCLOSURE FOR HACKTECH 2020")
...
def general_waiver(waiver_type, link, title):
    ...
    form_info = judging_helpers.get_waiver(
        auth_utils.get_user_id(email), waiver_type)
